...
const MobileIndex = React.memo(function MobileIndex({favoritesAdventurers}) {
	...
	return (
        ...
        <Link href={"/equipment"}>
          <button
            className={`box p-4 text-plain text-sm text-center transition-opacity ${
              router.pathname === "/equipment" ? "" : "cursor-pointer"
            }`}>
            {"Equipment"}
          </button>
        </Link>
        <Link href={"/crafting"}>
          <button
            className={`box p-4 text-plain text-sm text-center transition-opacity ${
              router.pathname === "/crafting" ? "" : "cursor-pointer"
            }`}>
            {"Crafting"}
          </button>
        </Link>
		*/}
        ...
        <Link href={"/feats"}>
          <button
            className={`box p-4 text-plain text-sm text-center transition-opacity ${
              router.pathname === "/feats" ? "" : "cursor-pointer"
            }`}>
            {"Feats"}
          </button>
        </Link>
        <Link href={"/farming"}>
          <button
            className={`box p-4 text-plain text-sm text-center transition-opacity ${
              router.pathname === "/farming" ? "" : "cursor-pointer"
            }`}>
            {"Farming"}
          </button>
        </Link>
        <Link href={"/bank"}>
          <button
            className={`box p-4 text-plain text-sm text-center transition-opacity ${
              router.pathname === "/bank" ? "" : "cursor-pointer"
            }`}>
            {"Bank"}
          </button>
        </Link> */}
