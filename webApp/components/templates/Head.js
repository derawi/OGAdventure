...
const MobileMenu = React.memo(function MobileMenu() {
  ...
  return (
    <>
      <div
        id={"footbar"}
        className={"block fixed bottom-0 left-0 w-full bg-white dark:bg-dark-600 transition-all duration-500 md:hidden"}
        style={{ zIndex: 10000 }}>
        ...
        <section className={"mx-auto mt-24 max-w-screen md:mt-12 md:max-w-screen-xl"}>
          ...
          <section className={"mx-auto mt-6 max-w-screen md:max-w-screen-xl"}>
            <div className={"flex flex-row items-center mb-4 border-b-2 dark:border-b-dark-300"}>
              <Link href={"/"}>
                <p
                  className={`p-4 pr-6 pl-0 text-plain text-sm transition-opacity hover:opacity-100 ${
                    router.pathname === "/" || router.pathname === "/recruit"
                      ? "opacity-100"
              ...
              {/* <Link href={"/adventures"}>
                <p
                  className={`p-4 pr-6 pl-0 text-plain text-sm transition-opacity hover:opacity-100 ${
                    router.pathname === "/adventures" || router.pathname.startsWith("/adventures")
                      ? "opacity-100"
                      : "opacity-20 cursor-pointer"
                  }`}>
                  {"Adventures"}
              ...
              <Link href={"/farming"}>
                <p
                  className={`p-4 pr-6 pl-0 text-plain text-sm transition-opacity hover:opacity-100 ${
                    router.pathname === "/farming" || router.pathname.startsWith("/farming")
                      ? "opacity-100"
                      : "opacity-20 cursor-pointer"
                  }`}>
                  {"Farming"}
              ...
              <Link href={"/crafting"}>
                <p
                  className={`p-4 pr-6 pl-0 text-plain text-sm transition-opacity hover:opacity-100 ${
                    router.pathname === "/crafting" ? "opacity-100" : "opacity-20 cursor-pointer"
                  }`}>
                  {"Crafting"}
                </p>
              </Link> */}
              <Link href={"/skills"}>
                <p
                  className={`p-4 pr-6 pl-0 text-plain text-sm transition-opacity hover:opacity-100 ${
                    router.pathname === "/skills" ? "opacity-100" : "opacity-20 cursor-pointer"
                  }`}>
                  {"Skills"}
                </p>
              </Link>
              {/* <Link href={"/feats"}>
                <p
                  className={`p-4 pr-6 pl-0 text-plain text-sm transition-opacity hover:opacity-100 ${
                    router.pathname === "/feats" ? "opacity-100" : "opacity-20 cursor-pointer"
                  }`}>
                  {"Feats"}
                </p>
              </Link>
              ...
              <Link href={"/equipment"}>
                <p
                  className={`p-4 pr-6 pl-0 text-plain text-sm transition-opacity hover:opacity-100 ${
                    router.pathname === "/equipment" ? "opacity-100" : "opacity-20 cursor-pointer"
                  }`}>
                  {"Equipment"}
                </p>
              </Link>
              <Link href={"/bank"}>
                <p
                  className={`p-4 pr-6 pl-0 ml-auto text-plain text-sm transition-opacity hover:opacity-100 ${
                    router.pathname === "/bank" ? "opacity-100" : "opacity-20 cursor-pointer"
                  }`}>
                  {"Bank"}
                </p>
              </Link> */}
