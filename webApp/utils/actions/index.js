...
export async function learnSkills({provider, tokenID, skills}, callback) {
	...
	const signer = provider.getSigner();
	const rarity = new ethers.Contract(process.env.RARITY_SKILLS_ADDR, process.env.RARITY_SKILLS_ABI, signer);
...
export async function learnFeat({provider, tokenID, feat}, callback) {
	...
	const signer = provider.getSigner();
	const rarity = new ethers.Contract(process.env.RARITY_FEATS_ADDR, process.env.RARITY_FEATS_ABI, signer);
...
export async function setAttributes({provider, _summoner, _str, _dex, _const, _int, _wis, _cha}, callback) {
	...
	const signer = provider.getSigner();
	const rarity = new ethers.Contract(process.env.RARITY_ATTR_ADDR, process.env.RARITY_ATTR_ABI, signer);
